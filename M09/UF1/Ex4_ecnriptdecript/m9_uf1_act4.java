...
public class M9_uf1_act4 {
	...
	clau = sc.nextLine();
	System.out.print("Introdueix la paraula que vols encriptar i desencriptar: ");
	paraulaEncriptada = sc.nextLine();
	...
	byte[] data;
        data = paraulaEncriptada.getBytes();
	byte[] encryptData;
